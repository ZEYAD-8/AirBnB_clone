...
class TestBaseModelInitialization(unittest.TestCase):
    ...
    def testCustomInitialization(self):
        ...
        obj = BaseModel(id=customId, created_at=customCreatedAt, updated_at=customUpdatedAt, customAttribute="test")
    ...
    def testWithStrDates(self):
        strDate = {"created_at":"2017-09-28T21:05:54.119427",
                "updated_at":"2017-09-28T21:05:54.119427"
                }
        obj = BaseModel(**strDate)
        self.assertIsInstance(obj.updated_at, datetime)
        self.assertIsInstance(obj.created_at, datetime)
        self.assertEqual(obj.created_at, datetime.strptime(strDate["created_at"], "%Y-%m-%dT%H:%M:%S.%f"))
        self.assertEqual(obj.updated_at, datetime.strptime(strDate["updated_at"], "%Y-%m-%dT%H:%M:%S.%f"))
